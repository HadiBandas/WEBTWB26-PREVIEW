    ...
    booking: [
        {
            ...
            answer: {
                en: 'You can make a reservation through WhatsApp (+62 812 3456 7890), email (reservation@bougenville.com), or by using the booking form on our website. Our team will respond within 24 hours to confirm availability and provide payment instructions.',
                id: 'Anda dapat melakukan reservasi melalui WhatsApp (+62 812 3456 7890), email (reservation@bougenville.com), atau menggunakan formulir pemesanan di website kami. Tim kami akan merespons dalam 24 jam untuk konfirmasi ketersediaan dan instruksi pembayaran.',
                zh: '您可以通过 WhatsApp (+62 812 3456 7890)、电子邮件 (reservation@bougenville.com) 或使用我们网站上的预订表格进行预订。我们的团队将在 24 小时内回复以确认空房情况并提供付款说明。',
                de: 'Sie können eine Reservierung über WhatsApp (+62 812 3456 7890), E-Mail (reservation@bougenville.com) oder über das Buchungsformular auf unserer Website vornehmen. Unser Team wird innerhalb von 24 Stunden antworten, um die Verfügbarkeit zu bestätigen und Zahlungsanweisungen zu geben.'
            }
        },
        {
            question: {
